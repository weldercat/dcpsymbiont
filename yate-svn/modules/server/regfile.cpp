...
{
    String dbguser = msg.getValue("caller");
    String dbgusername = msg.getValue("called");
    Debug(DebugInfo,"regfile route handler: caller=%s, called=%s", dbguser.c_str(), dbgusername.c_str());
